...
var eddb = {
	...
	//	{ attr:'minebonus',                                   abbr:'MnBn', name:'Mining Bonus',                             min:0,                  default:0, scale:1,             desc:'' }, // iplc
		...
		{ attr:'agzresist',                                   abbr:'AGZR', name:'Anti Guardian Zone Resistance',            min:0, max:1,           default:0, scale:0,             desc:'Resistance to Thargoid anti-Guardian field' },
	], // eddb.attributes[]
	fdfieldattr : {
		BurstRate           : 'bstrof',
		BurstSize           : 'bstsize',
