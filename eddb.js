...
var eddb = {
	...
	blueprint : {
		wpn_ds : { name:'Double Shot', maxgrade:5, maximumrng:[-2,-4,-6,-8,-10], bstrof:[6,8,10,12,14], bstsize:[2,2,2,2,2], ammoclip:[15,20,25,30,35], fdname:'Weapon_DoubleShot' },
		...
		wpn_foc : { name:'Focused', maxgrade:5, thmload:[1,2,3,4,5], pierce:[40,60,80,100,120], maximumrng:[36,52,68,84,100], dmgfall:[36,52,68,84,100], fdname:'Weapon_Focused' },
		...
		wpn_lr : { name:'Long Range', maxgrade:5, mass:[10,15,20,25,30], pwrdraw:[3,6,9,12,15], maximumrng:[20,40,60,80,100], dmgfall:[1000,1000,1000,1000,1000], fdname:'Weapon_LongRange' },
		...
		wpn_sr : { name:'Short Range', maxgrade:5, damage:[27,39,51,63,75], thmload:[0,10,20,30,40], maximumrng:[-10,-20,-30,-40,-50], fdname:'Weapon_ShortRange' },
		...
		ct_ct : { name:'Clean Tuning', maxgrade:5, integ:[0,-4,-8,-12,-16], pwrdraw:[0,4,8,12,16], engoptmass:[-2,-4,-6,-8,-10], engoptmul:[8,13,18,23,28], engheat:[-20,-30,-40,-50,-60],  fdname:'Engine_Tuned' },
		ct_dt : { name:'Dirty Tuning', maxgrade:5, integ:[-3,-6,-9,-12,-15], pwrdraw:[4,6,8,10,12], engoptmass:[-2.5,-5,-7.5,-10,-12.5], engoptmul:[12,19,26,33,40], engheat:[20,30,40,50,60], fdname:'Engine_Dirty' },
		ct_str : { name:'Strengthening', maxgrade:5, mass:[5,10,15,20,25], integ:[30,50,70,90,110], engheat:[-10,-20,-30,-40,-50], fdname:'Engine_Reinforced' },
		cfsd_fb : { name:'Faster Boot', maxgrade:5, integ:[-3,-6,-9,-12,-15], boottime:[-20,-35,-50,-65,-80], fsdoptmass:[3,6,9,12,15], fsdheat:[4,8,12,16,20], fdname:'FSD_FastBoot' },
		cfsd_ir : { name:'Increased Range', maxgrade:5, mass:[10,15,20,25,30], integ:[-3,-6,-9,-12,-15], pwrdraw:[3,6,9,12,15], fsdoptmass:[15,25,35,45,55], fdname:'FSD_LongRange' },
		cfsd_sh : { name:'Shielded', maxgrade:5, mass:[4,8,12,16,20], integ:[25,50,75,100,125], fsdoptmass:[3,6,9,12,15], fsdheat:[-10,-15,-20,-25,-30], fdname:'FSD_Shielded' },
		...
		cs_lw : { name:'Light Weight', maxgrade:5, mass:[-20,-35,-50,-65,-80], integ:[-10,-20,-30,-40,-50], scanangle:[-5,-10,-15,-20,-25], fdname:'Sensor_LightWeight' },
		cs_lr : { name:'Long Range', maxgrade:5, mass:[20,40,60,80,100], scanangle:[-10,-15,-20,-25,-30], typemis:[15,30,45,60,75], fdname:'Sensor_LongRange' },
		cs_wa : { name:'Wide Angle', maxgrade:5, pwrdraw:[10,20,30,40,50], scanangle:[40,80,120,160,200], typemis:[-4,-8,-12,-16,-20], fdname:'Sensor_WideAngle' },
		...
		iscb_rc : { name:'Rapid Charge', maxgrade:4, boottime:[10,15,20,25], spinup:[-10,-20,-30,-40], shieldrnfps:[5,10,15,20], scbdur:[-6,-12,-18,-24], fdname:'ShieldCellBank_Rapid' },
		iscb_sp : { name:'Specialised', maxgrade:4, integ:[-5,-10,-15,-20], pwrdraw:[10,15,20,25], boottime:[-8,-16,-24,-32], shieldrnfps:[4,6,8,10], scbheat:[-6,-12,-18,-24], fdname:'ShieldCellBank_Specialised' },
		isg_elp : { name:'Enhanced, Low Power', maxgrade:5, mass:[-18,-26,-34,-42,-50], integ:[-5,-10,-15,-20,-25], pwrdraw:[-20,-25,-30,-35,-40], genoptmass:[-2,-3,-4,-5,-6], genoptmul:[3,6,9,12,15], fdname:'ShieldGenerator_Optimised' },
		...
		isg_rf : { name:'Reinforced', maxgrade:5, genoptmul:[14,20,26,32,38], bgenrate:[-10,-10,-10,-10,-10], genpwr:[4,6,8,10,12], kinres:[4.5,7.5,10.5,13.5,16.5], thmres:[4.5,7.5,10.5,13.5,16.5], expres:[4.5,7.5,10.5,13.5,16.5], fdname:'ShieldGenerator_Reinforced' },
	...
	module : {
		...
		70330 : { mtype:'hc',  cost:  675200, name:'Cannon',                      mount:'F',              class:3, rating:'C', mass: 8.00, integ:64, pwrdraw:0.67, boottime:0, dps:23.372, damage:55.625, distdraw:1.070, thmload:3.20, pierce: 70, maximumrng:4000, shotspd: 960, rof:0.420, bstint:2.380,                      ammoclip: 6, ammomax: 120,            rldtime:3.0, brcdmg:52.8, minbrc:60, maxbrc:90,             kinwgt:100, expwgt:0, dmgfall:4000, ammocost:20, fdid:128049440, fdname:'Hpt_Cannon_Fixed_Large' },
	...
	//	30253 : { mtype:'isg', cost:        0, name:'Shield Generator', class:2, rating:'E', mass:  2.50, integ: 41, pwrdraw:0.90, boottime:1, genminmass: 28.0, genoptmass:  55.0, genmaxmass: 138.0, genminmul:30, genoptmul: 80, genmaxmul:130, genrate:1.0, bgenrate:1.60, thmload:1.2, genpwr:0.6, kinres:40.0, thmres:-20.0, expres:50.0, axeres:95.0, limit:'isg', fdid:128666641, fdname:'Int_ShieldGenerator_Size2_Class1_free' }, // TODO?
		...
		30850 : { mtype:'isg', cost:  2007240, name:'Shield Generator', class:8, rating:'E', mass:160.00, integ:120, pwrdraw:2.40, boottime:1, genminmass:900.0, genoptmass:1800.0, genmaxmass:4500.0, genminmul:30, genoptmul: 80, genmaxmul:130, genrate:2.4, bgenrate:9.6 , thmload:1.2, genpwr:0.6, kinres:40.0, thmres:-20.0, expres:50.0, axeres:95.0, limit:'isg', fdid:128064293, fdname:'Int_ShieldGenerator_Size8_Class1' },
		30840 : { mtype:'isg', cost:  6021720, name:'Shield Generator', class:8, rating:'D', mass: 64.00, integ: 90, pwrdraw:3.20, boottime:1, genminmass:900.0, genoptmass:1800.0, genmaxmass:4500.0, genminmul:40, genoptmul: 90, genmaxmul:140, genrate:2.4, bgenrate:9.6 , thmload:1.2, genpwr:0.6, kinres:40.0, thmres:-20.0, expres:50.0, axeres:95.0, limit:'isg', fdid:128064294, fdname:'Int_ShieldGenerator_Size8_Class2' },
		30830 : { mtype:'isg', cost: 18065170, name:'Shield Generator', class:8, rating:'C', mass:160.00, integ:150, pwrdraw:4.00, boottime:1, genminmass:900.0, genoptmass:1800.0, genmaxmass:4500.0, genminmul:50, genoptmul:100, genmaxmul:150, genrate:2.4, bgenrate:9.6 , thmload:1.2, genpwr:0.6, kinres:40.0, thmres:-20.0, expres:50.0, axeres:95.0, limit:'isg', fdid:128064295, fdname:'Int_ShieldGenerator_Size8_Class3' },
		30820 : { mtype:'isg', cost: 54195500, name:'Shield Generator', class:8, rating:'B', mass:256.00, integ:210, pwrdraw:4.80, boottime:1, genminmass:900.0, genoptmass:1800.0, genmaxmass:4500.0, genminmul:60, genoptmul:110, genmaxmul:160, genrate:2.4, bgenrate:9.6 , thmload:1.2, genpwr:0.6, kinres:40.0, thmres:-20.0, expres:50.0, axeres:95.0, limit:'isg', fdid:128064296, fdname:'Int_ShieldGenerator_Size8_Class4' },
		30810 : { mtype:'isg', cost:162586490, name:'Shield Generator', class:8, rating:'A', mass:160.00, integ:180, pwrdraw:5.60, boottime:1, genminmass:900.0, genoptmass:1800.0, genmaxmass:4500.0, genminmul:70, genoptmul:120, genmaxmul:170, genrate:2.4, bgenrate:9.6 , thmload:1.2, genpwr:0.6, kinres:40.0, thmres:-20.0, expres:50.0, axeres:95.0, limit:'isg', fdid:128064297, fdname:'Int_ShieldGenerator_Size8_Class5' },
		
		30132 : { mtype:'isg', cost:     7710, name:'Bi-Weave Shield Generator',  class:1, rating:'C', mass:  1.30, integ: 40, pwrdraw:1.20, boottime:1, genminmass: 13.0, genoptmass:  25.0, genmaxmass:  63.0, genminmul: 40, genoptmul: 90, genmaxmul:140, genrate: 1.8, bgenrate: 2.400, thmload:1.2, genpwr:0.6, kinres:40.0, thmres:-20.0, expres:50.0, axeres:95.0, limit:'isg', fdid:128671331, fdname:'Int_ShieldGenerator_Size1_Class3_Fast' },
