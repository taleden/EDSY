...
var eddb = {
	version : 424009901,
	edsy_versions_db : [419039901,423009901,424009901,424009901], /* HTML,CSS,DB,JS */
	edsy_lastmodified_db : 20260810,
	ship : {
		 1 : {
		...
		38 : {
			...
			heatcap:300, heatdismin:2.68, heatdismax:52.15, fuelcost:50, fuelreserve:0.60, hardness:58, masslock:15, crew:3, // verify: masslock
			slots:{
		...
		54 : {
			...
			heatcap:NaN, heatdismin:1.67, heatdismax:NaN, fuelcost:50, fuelreserve:0.75, hardness:55, masslock:16, crew:2, // TODO: heatcap,heatdismax
			slots:{
				hardpoint:[3,2,2,2,2],
				utility  :[0,0,0,0],
