...
var eddb = {
	...
	ship : {
		...
		14 : {
			...
			module:{
				...
				40122 : { cost: 18325680, mass:36.00, fdid:128816570, fdname:'Krait_MkII_Armour_Grade2' }, // Reinforced Alloy
				40113 : { cost: 41232790, mass:67.00, fdid:128816571, fdname:'Krait_MkII_Armour_Grade3' }, // Military Grade Composite
				40114 : { cost: 97446810, mass:67.00, fdid:128816572, fdname:'Krait_MkII_Armour_Mirrored' }, // Mirrored Surface Composite
				40115 : { cost:107984080, mass:67.00, fdid:128816573, fdname:'Krait_MkII_Armour_Reactive' }, // Reactive Surface Composite
			},
		},
		51 : {
	...
	mattype : {
		enc : { name:'Encoded', abbr:'Enc' },
		mfc : { name:'Manufactured', abbr:'Mfc' },
		raw : { name:'Raw', abbr:'Raw' },
	},
	material : {
		abshpaan : { name:'Aberrant Shield Pattern Analysis', mattype:'enc', rarity:4, fdid:128681633, fdname:'ShieldPatternAnalysis' },
		abcoemda : { name:'Abnormal Compact Emissions Data', mattype:'enc', rarity:5, fdid:128681638, fdname:'CompactEmissionsData' },
		adenca   : { name:'Adaptive Encryptors Capture', mattype:'enc', rarity:5, fdid:128681635, fdname:'AdaptiveEncryptors' },
		anbuscda : { name:'Anomalous Bulk Scan Data', mattype:'enc', rarity:1, fdid:128681612, fdname:'BulkScanData' },
		anfste   : { name:'Anomalous FSD Telemetry', mattype:'enc', rarity:2, fdid:128681619, fdname:'FSDTelemetry' },
		...
		atdiwaec : { name:'Atypical Disrupted Wake Echoes', mattype:'enc', rarity:1, fdid:128681613, fdname:'DisruptedWakeEchoes' },
		atenar   : { name:'Atypical Encryption Archives', mattype:'enc', rarity:4, fdid:128681629, fdname:'EncryptionArchives' },
		baco     : { name:'Basic Conductors', mattype:'mfc', rarity:1, fdid:128673880, fdname:'BasicConductors' },
		bimeco   : { name:'Bio-Mechanical Conduits', mattype:'mfc', rarity:3, fdid:128737287, fdname:'TG_BioMechanicalConduits' },
		bico     : { name:'Biotech Conductors', mattype:'mfc', rarity:5, fdid:128673920, fdname:'BiotechConductors' },
		...
		chdi     : { name:'Chemical Distillery', mattype:'mfc', rarity:3, fdid:128673906, fdname:'ChemicalDistillery' },
		chma     : { name:'Chemical Manipulators', mattype:'mfc', rarity:4, fdid:128673916, fdname:'ChemicalManipulators' },
		chpr     : { name:'Chemical Processors', mattype:'mfc', rarity:2, fdid:128673896, fdname:'ChemicalProcessors' },
		chstun   : { name:'Chemical Storage Units', mattype:'mfc', rarity:1, fdid:128673886, fdname:'ChemicalStorageUnits' },
		chr      : { name:'Chromium', mattype:'raw', rarity:2, fdid:128672327, fdname:'Chromium' },
		clscda   : { name:'Classified Scan Databanks', mattype:'enc', rarity:3, fdid:128681624, fdname:'ScanDatabanks' },
		clscfr   : { name:'Classified Scan Fragment', mattype:'enc', rarity:5, fdid:128681636, fdname:'ClassifiedScanData' },
		compco   : { name:'Compact Composites', mattype:'mfc', rarity:1, fdid:128673884, fdname:'CompactComposites' },
		cosh     : { name:'Compound Shielding', mattype:'mfc', rarity:4, fdid:128673913, fdname:'CompoundShielding' },
		coce     : { name:'Conductive Ceramics', mattype:'mfc', rarity:3, fdid:128673900, fdname:'ConductiveCeramics' },
		condco   : { name:'Conductive Components', mattype:'mfc', rarity:2, fdid:128673890, fdname:'ConductiveComponents' },
		copo     : { name:'Conductive Polymers', mattype:'mfc', rarity:4, fdid:128673910, fdname:'ConductivePolymers' },
		confco   : { name:'Configurable Components', mattype:'mfc', rarity:4, fdid:128673911, fdname:'ConfigurableComponents' },
		codyco   : { name:'Core Dynamics Composites', mattype:'mfc', rarity:5, fdid:128673924, fdname:'FedCoreComposites' },
		crinfi   : { name:'Cracked Industrial Firmware', mattype:'enc', rarity:3, fdid:128681622, fdname:'IndustrialFirmware' },
		crsh     : { name:'Crystal Shards', mattype:'mfc', rarity:1, fdid:128673878, fdname:'CrystalShards' },
		dawaex   : { name:'Datamined Wake Exceptions', mattype:'enc', rarity:5, fdid:128681637, fdname:'DataminedWake' },
		deemda   : { name:'Decoded Emission Data', mattype:'enc', rarity:4, fdid:128681632, fdname:'DecodedEmissionData' },
		dishcyre : { name:'Distorted Shield Cycle Recordings', mattype:'enc', rarity:1, fdid:128681615, fdname:'ShieldCycleRecordings' },
		discda   : { name:'Divergent Scan Data', mattype:'enc', rarity:4, fdid:128681630, fdname:'EncodedScanData' },
		echytr   : { name:'Eccentric Hyperspace Trajectories', mattype:'enc', rarity:4, fdid:128681631, fdname:'HyperspaceTrajectories' },
		elar     : { name:'Electrochemical Arrays', mattype:'mfc', rarity:3, fdid:128673897, fdname:'ElectrochemicalArrays' },
		exscemda : { name:'Exceptional Scrambled Emission Data', mattype:'enc', rarity:1, fdid:128681614, fdname:'ScrambledEmissionData' },
		exfocr   : { name:'Exquisite Focus Crystals', mattype:'mfc', rarity:5, fdid:128673918, fdname:'ExquisiteFocusCrystals' },
		fico     : { name:'Filament Composites', mattype:'mfc', rarity:2, fdid:128673894, fdname:'FilamentComposites' },
		flfocr   : { name:'Flawed Focus Crystals', mattype:'mfc', rarity:2, fdid:128673888, fdname:'UncutFocusCrystals' },
		focr     : { name:'Focus Crystals', mattype:'mfc', rarity:3, fdid:128673898, fdname:'FocusCrystals' },
		gaal     : { name:'Galvanising Alloys', mattype:'mfc', rarity:2, fdid:128673895, fdname:'GalvanisingAlloys' },
		ger      : { name:'Germanium', mattype:'raw', rarity:2, fdid:128672329, fdname:'Germanium' },
		grre     : { name:'Grid Resistors', mattype:'mfc', rarity:1, fdid:128673877, fdname:'GridResistors' },
		gumoblse : { name:'Guardian Module Blueprint Segment', mattype:'enc', rarity:4, fdid:128815029, fdname:'Guardian_ModuleBlueprint' },
		gupoce   : { name:'Guardian Power Cell', mattype:'mfc', rarity:1, fdid:128815023, fdname:'Guardian_PowerCell' },
		gupoco   : { name:'Guardian Power Conduit', mattype:'mfc', rarity:2, fdid:128815024, fdname:'Guardian_PowerConduit' },
		gusewepa : { name:'Guardian Sentinel Weapon Parts', mattype:'mfc', rarity:3, fdid:128815026, fdname:'Guardian_Sentinel_WeaponParts' },
		gusewrco : { name:'Guardian Sentinel Wreckage Components', mattype:'mfc', rarity:1, fdid:128815027, fdname:'Guardian_Sentinel_WreckageComponents' },
		guteco   : { name:'Guardian Technology Component', mattype:'mfc', rarity:3, fdid:128815025, fdname:'Guardian_TechComponent' },
		guveblse : { name:'Guardian Vessel Blueprint Segment', mattype:'enc', rarity:5, fdid:128815030, fdname:'Guardian_VesselBlueprint' },
		guweblse : { name:'Guardian Weapon Blueprint Segment', mattype:'enc', rarity:4, fdid:128815028, fdname:'Guardian_WeaponBlueprint' },
		hecowi   : { name:'Heat Conduction Wiring', mattype:'mfc', rarity:1, fdid:128673882, fdname:'HeatConductionWiring' },
		hedipl   : { name:'Heat Dispersion Plate', mattype:'mfc', rarity:2, fdid:128673892, fdname:'HeatDispersionPlate' },
		heex     : { name:'Heat Exchangers', mattype:'mfc', rarity:3, fdid:128673902, fdname:'HeatExchangers' },
		herece   : { name:'Heat Resistant Ceramics', mattype:'mfc', rarity:2, fdid:128673889, fdname:'HeatResistantCeramics' },
		heva     : { name:'Heat Vanes', mattype:'mfc', rarity:4, fdid:128673912, fdname:'HeatVanes' },
		hideco   : { name:'High Density Composites', mattype:'mfc', rarity:3, fdid:128673904, fdname:'HighDensityComposites' },
		hyca     : { name:'Hybrid Capacitors', mattype:'mfc', rarity:2, fdid:128673887, fdname:'HybridCapacitors' },
		imsh     : { name:'Imperial Shielding', mattype:'mfc', rarity:5, fdid:128673923, fdname:'ImperialShielding' },
		imco     : { name:'Improvised Components', mattype:'mfc', rarity:5, fdid:128673921, fdname:'ImprovisedComponents' },
		inshsoan : { name:'Inconsistent Shield Soak Analysis', mattype:'enc', rarity:2, fdid:128681621, fdname:'ShieldSoakAnalysis' },
		iro      : { name:'Iron', mattype:'raw', rarity:1, fdid:128672318, fdname:'Iron' },
		iremda   : { name:'Irregular Emission Data', mattype:'enc', rarity:2, fdid:128681620, fdname:'ArchivedEmissionData' },
		...
		meco     : { name:'Mechanical Components', mattype:'mfc', rarity:3, fdid:128673901, fdname:'MechanicalComponents' },
		meeq     : { name:'Mechanical Equipment', mattype:'mfc', rarity:2, fdid:128673891, fdname:'MechanicalEquipment' },
		mesc     : { name:'Mechanical Scrap', mattype:'mfc', rarity:1, fdid:128673881, fdname:'MechanicalScrap' },
		mer      : { name:'Mercury', mattype:'raw', rarity:3, fdid:128672336, fdname:'Mercury' },
		migral   : { name:'Military Grade Alloys', mattype:'mfc', rarity:5, fdid:128673919, fdname:'MilitaryGradeAlloys' },
		misu     : { name:'Military Supercapacitors', mattype:'mfc', rarity:5, fdid:128673917, fdname:'MilitarySupercapacitors' },
		mocofi   : { name:'Modified Consumer Firmware', mattype:'enc', rarity:2, fdid:128681616, fdname:'ConsumerFirmware' },
		moemfi   : { name:'Modified Embedded Firmware', mattype:'enc', rarity:5, fdid:128681634, fdname:'EmbeddedFirmware' },
		...
		opsyke   : { name:'Open Symmetric Keys', mattype:'enc', rarity:3, fdid:128681623, fdname:'SymmetricKeys' },
		paalobda : { name:'Pattern Alpha Obelisk Data', mattype:'enc', rarity:4, fdid:128732198, fdname:'AncientBiologicalData' },
		pabeobda : { name:'Pattern Beta Obelisk Data', mattype:'enc', rarity:4, fdid:128732199, fdname:'AncientCulturalData' },
		padeobda : { name:'Pattern Delta Obelisk Data', mattype:'enc', rarity:4, fdid:128732197, fdname:'AncientLanguageData' },
		paepobda : { name:'Pattern Epsilon Obelisk Data', mattype:'enc', rarity:4, fdid:128732201, fdname:'AncientTechnologicalData' },
		pagaobda : { name:'Pattern Gamma Obelisk Data', mattype:'enc', rarity:4, fdid:128732200, fdname:'AncientHistoricalData' },
		peshfrda : { name:'Peculiar Shield Frequency Data', mattype:'enc', rarity:5, fdid:128681639, fdname:'ShieldFrequencyData' },
		phis     : { name:'Pharmaceutical Isolators', mattype:'mfc', rarity:5, fdid:128673926, fdname:'PharmaceuticalIsolators' },
		phal     : { name:'Phase Alloys', mattype:'mfc', rarity:3, fdid:128673905, fdname:'PhaseAlloys' },
		...
		poca     : { name:'Polymer Capacitors', mattype:'mfc', rarity:4, fdid:128673907, fdname:'PolymerCapacitors' },
		pral     : { name:'Precipitated Alloys', mattype:'mfc', rarity:3, fdid:128673899, fdname:'PrecipitatedAlloys' },
		prco     : { name:'Proprietary Composites', mattype:'mfc', rarity:4, fdid:128673914, fdname:'FedProprietaryComposites' },
		prel     : { name:'Propulsion Elements', mattype:'mfc', rarity:5, fdid:128793132, fdname:'TG_PropulsionElement' },
		prhera   : { name:'Proto Heat Radiators', mattype:'mfc', rarity:5, fdid:128673922, fdname:'ProtoHeatRadiators' },
		prlial   : { name:'Proto Light Alloys', mattype:'mfc', rarity:4, fdid:128673915, fdname:'ProtoLightAlloys' },
		prraal   : { name:'Proto Radiolic Alloys', mattype:'mfc', rarity:5, fdid:128673925, fdname:'ProtoRadiolicAlloys' },
		refocr   : { name:'Refined Focus Crystals', mattype:'mfc', rarity:4, fdid:128673908, fdname:'RefinedFocusCrystals' },
		...
		saal     : { name:'Salvaged Alloys', mattype:'mfc', rarity:1, fdid:128673885, fdname:'SalvagedAlloys' },
		sefipa   : { name:'Security Firmware Patch', mattype:'enc', rarity:4, fdid:128681628, fdname:'SecurityFirmware' },
		sel      : { name:'Selenium', mattype:'raw', rarity:4, fdid:128672326, fdname:'Selenium' },
		sefr     : { name:'Sensor Fragment', mattype:'mfc', rarity:5, fdid:128681640, fdname:'UnknownEnergySource' },
		shem     : { name:'Shield Emitters', mattype:'mfc', rarity:2, fdid:128673893, fdname:'ShieldEmitters' },
		shse     : { name:'Shielding Sensors', mattype:'mfc', rarity:3, fdid:128673903, fdname:'ShieldingSensors' },
		shflda   : { name:'Ship Flight Data', mattype:'enc', rarity:3, fdid:128793135, fdname:'TG_ShipFlightData' },
		shsyda   : { name:'Ship Systems Data', mattype:'enc', rarity:4, fdid:128793136, fdname:'TG_ShipSystemsData' },
		splefi   : { name:'Specialised Legacy Firmware', mattype:'enc', rarity:1, fdid:128681610, fdname:'LegacyFirmware' },
		stwaso   : { name:'Strange Wake Solutions', mattype:'enc', rarity:3, fdid:128681625, fdname:'WakeSolutions' },
		sul      : { name:'Sulphur', mattype:'raw', rarity:1, fdid:128672323, fdname:'Sulphur' },
		taenco   : { name:'Tagged Encryption Codes', mattype:'enc', rarity:2, fdid:128681617, fdname:'EncryptionCodes' },
		...
		teal     : { name:'Tempered Alloys', mattype:'mfc', rarity:1, fdid:128673879, fdname:'TemperedAlloys' },
		thca     : { name:'Thargoid Carapace', mattype:'mfc', rarity:2, fdid:128737283, fdname:'UnknownCarapace' },
		thence   : { name:'Thargoid Energy Cell', mattype:'mfc', rarity:3, fdid:128737284, fdname:'UnknownEnergyCell' },
		thmacoda : { name:'Thargoid Material Composition Data', mattype:'enc', rarity:3, fdid:128737280, fdname:'TG_CompositionData' },
		thorci   : { name:'Thargoid Organic Circuitry', mattype:'mfc', rarity:5, fdid:128737285, fdname:'UnknownOrganicCircuitry' },
		threda   : { name:'Thargoid Residue Data', mattype:'enc', rarity:4, fdid:128737281, fdname:'TG_ResidueData' },
		thshsi   : { name:'Thargoid Ship Signature', mattype:'enc', rarity:3, fdid:128731669, fdname:'UnknownShipSignature' },
		thstda   : { name:'Thargoid Structural Data', mattype:'enc', rarity:2, fdid:128737282, fdname:'TG_StructuralData' },
		thteco   : { name:'Thargoid Technological Components', mattype:'mfc', rarity:4, fdid:128737286, fdname:'UnknownTechnologyComponents' },
		thwada   : { name:'Thargoid Wake Data', mattype:'enc', rarity:4, fdid:128731670, fdname:'UnknownWakeData' },
		thal     : { name:'Thermic Alloys', mattype:'mfc', rarity:4, fdid:128673909, fdname:'ThermicAlloys' },
		...
		unemda   : { name:'Unexpected Emission Data', mattype:'enc', rarity:3, fdid:128681626, fdname:'EmissionData' },
		unscar   : { name:'Unidentified Scan Archives', mattype:'enc', rarity:2, fdid:128681618, fdname:'ScanArchives' },
		unshsc   : { name:'Untypical Shield Scans ', mattype:'enc', rarity:3, fdid:128681627, fdname:'ShieldDensityReports' },
		unenfi   : { name:'Unusual Encrypted Files', mattype:'enc', rarity:1, fdid:128681611, fdname:'EncryptedFiles' },
		van      : { name:'Vanadium', mattype:'raw', rarity:2, fdid:128672328, fdname:'Vanadium' },
		wepa     : { name:'Weapon Parts', mattype:'mfc', rarity:4, fdid:128793133, fdname:'TG_WeaponParts' },
		woshem   : { name:'Worn Shield Emitters', mattype:'mfc', rarity:1, fdid:128673883, fdname:'WornShieldEmitters' },
		wrco     : { name:'Wreckage Components', mattype:'mfc', rarity:3, fdid:128793134, fdname:'TG_WreckageComponents' },
	...
	//	43810 : { mtype:'cfsd', cost:         , name:'Frame Shift Drive', class:8, rating:'A', mass:      , integ:   , pwrdraw:    , boottime:10, fsdoptmass:      , fsdheat:    , maxfuel:     , fuelmul:0.012, fuelpower:2.90, fdid:128064137, fdname:'Int_Hyperdrive_Size8_Class5' },
		...
		46150 : { mtype:'cs', cost:     520, name:'Sensors', class:1, rating:'E', mass:  1.30, integ: 36, pwrdraw:0.16, boottime:5, maxrng:8.00, scanangle:30.00, typemis:4000, fdid:128064218, fdname:'Int_Sensors_Size1_Class1' }, // verify price
		46140 : { mtype:'cs', cost:    1290, name:'Sensors', class:1, rating:'D', mass:  0.50, integ: 32, pwrdraw:0.18, boottime:5, maxrng:8.00, scanangle:30.00, typemis:4500, fdid:128064219, fdname:'Int_Sensors_Size1_Class2' }, // verify price
		46130 : { mtype:'cs', cost:    3230, name:'Sensors', class:1, rating:'C', mass:  1.30, integ: 40, pwrdraw:0.20, boottime:5, maxrng:8.00, scanangle:30.00, typemis:5000, fdid:128064220, fdname:'Int_Sensors_Size1_Class3' }, // verify price
		46120 : { mtype:'cs', cost:    8080, name:'Sensors', class:1, rating:'B', mass:  2.00, integ: 48, pwrdraw:0.33, boottime:5, maxrng:8.00, scanangle:30.00, typemis:5500, fdid:128064221, fdname:'Int_Sensors_Size1_Class4' }, // verify price
		46110 : { mtype:'cs', cost:   20200, name:'Sensors', class:1, rating:'A', mass:  1.30, integ: 44, pwrdraw:0.60, boottime:5, maxrng:8.00, scanangle:30.00, typemis:6000, fdid:128064222, fdname:'Int_Sensors_Size1_Class5' }, // verify price
		
		46250 : { mtype:'cs', cost:    1450, name:'Sensors', class:2, rating:'E', mass:  2.50, integ: 46, pwrdraw:0.18, boottime:5, maxrng:8.00, scanangle:30.00, typemis:4160, fdid:128064223, fdname:'Int_Sensors_Size2_Class1' }, // verify price
		46240 : { mtype:'cs', cost:    3620, name:'Sensors', class:2, rating:'D', mass:  1.00, integ: 41, pwrdraw:0.21, boottime:5, maxrng:8.00, scanangle:30.00, typemis:4680, fdid:128064224, fdname:'Int_Sensors_Size2_Class2' }, // verify price
		46230 : { mtype:'cs', cost:    9050, name:'Sensors', class:2, rating:'C', mass:  2.50, integ: 51, pwrdraw:0.23, boottime:5, maxrng:8.00, scanangle:30.00, typemis:5200, fdid:128064225, fdname:'Int_Sensors_Size2_Class3' }, // verify price
		46220 : { mtype:'cs', cost:   22620, name:'Sensors', class:2, rating:'B', mass:  4.00, integ: 61, pwrdraw:0.38, boottime:5, maxrng:8.00, scanangle:30.00, typemis:5720, fdid:128064226, fdname:'Int_Sensors_Size2_Class4' }, // verify price
		46210 : { mtype:'cs', cost:   56550, name:'Sensors', class:2, rating:'A', mass:  2.50, integ: 56, pwrdraw:0.69, boottime:5, maxrng:8.00, scanangle:30.00, typemis:6240, fdid:128064227, fdname:'Int_Sensors_Size2_Class5' }, // verify price
		
		46350 : { mtype:'cs', cost:    4050, name:'Sensors', class:3, rating:'E', mass:  5.00, integ: 58, pwrdraw:0.22, boottime:5, maxrng:8.00, scanangle:30.00, typemis:4320, fdid:128064228, fdname:'Int_Sensors_Size3_Class1' },
		46340 : { mtype:'cs', cost:   10130, name:'Sensors', class:3, rating:'D', mass:  2.00, integ: 51, pwrdraw:0.25, boottime:5, maxrng:8.00, scanangle:30.00, typemis:4860, fdid:128064229, fdname:'Int_Sensors_Size3_Class2' },
		46330 : { mtype:'cs', cost:   25330, name:'Sensors', class:3, rating:'C', mass:  5.00, integ: 64, pwrdraw:0.28, boottime:5, maxrng:8.00, scanangle:30.00, typemis:5400, fdid:128064230, fdname:'Int_Sensors_Size3_Class3' },
		46320 : { mtype:'cs', cost:   63330, name:'Sensors', class:3, rating:'B', mass:  8.00, integ: 77, pwrdraw:0.46, boottime:5, maxrng:8.00, scanangle:30.00, typemis:5940, fdid:128064231, fdname:'Int_Sensors_Size3_Class4' },
		46310 : { mtype:'cs', cost:  158330, name:'Sensors', class:3, rating:'A', mass:  5.00, integ: 70, pwrdraw:0.84, boottime:5, maxrng:8.00, scanangle:30.00, typemis:6480, fdid:128064232, fdname:'Int_Sensors_Size3_Class5' },
		
		46450 : { mtype:'cs', cost:   11350, name:'Sensors', class:4, rating:'E', mass: 10.00, integ: 72, pwrdraw:0.27, boottime:5, maxrng:8.00, scanangle:30.00, typemis:4480, fdid:128064233, fdname:'Int_Sensors_Size4_Class1' },
		46440 : { mtype:'cs', cost:   28370, name:'Sensors', class:4, rating:'D', mass:  4.00, integ: 64, pwrdraw:0.31, boottime:5, maxrng:8.00, scanangle:30.00, typemis:5040, fdid:128064234, fdname:'Int_Sensors_Size4_Class2' },
		46430 : { mtype:'cs', cost:   70930, name:'Sensors', class:4, rating:'C', mass: 10.00, integ: 80, pwrdraw:0.34, boottime:5, maxrng:8.00, scanangle:30.00, typemis:5600, fdid:128064235, fdname:'Int_Sensors_Size4_Class3' },
		46420 : { mtype:'cs', cost:  177330, name:'Sensors', class:4, rating:'B', mass: 16.00, integ: 96, pwrdraw:0.56, boottime:5, maxrng:8.00, scanangle:30.00, typemis:6160, fdid:128064236, fdname:'Int_Sensors_Size4_Class4' },
		46410 : { mtype:'cs', cost:  443330, name:'Sensors', class:4, rating:'A', mass: 10.00, integ: 88, pwrdraw:1.02, boottime:5, maxrng:8.00, scanangle:30.00, typemis:6720, fdid:128064237, fdname:'Int_Sensors_Size4_Class5' },
		
		46550 : { mtype:'cs', cost:   31780, name:'Sensors', class:5, rating:'E', mass: 20.00, integ: 86, pwrdraw:0.33, boottime:5, maxrng:8.00, scanangle:30.00, typemis:4640, fdid:128064238, fdname:'Int_Sensors_Size5_Class1' },
		46540 : { mtype:'cs', cost:   79440, name:'Sensors', class:5, rating:'D', mass:  8.00, integ: 77, pwrdraw:0.37, boottime:5, maxrng:8.00, scanangle:30.00, typemis:5220, fdid:128064239, fdname:'Int_Sensors_Size5_Class2' },
		46530 : { mtype:'cs', cost:  198610, name:'Sensors', class:5, rating:'C', mass: 20.00, integ: 96, pwrdraw:0.41, boottime:5, maxrng:8.00, scanangle:30.00, typemis:5800, fdid:128064240, fdname:'Int_Sensors_Size5_Class3' },
		46520 : { mtype:'cs', cost:  496530, name:'Sensors', class:5, rating:'B', mass: 32.00, integ:115, pwrdraw:0.68, boottime:5, maxrng:8.00, scanangle:30.00, typemis:6380, fdid:128064241, fdname:'Int_Sensors_Size5_Class4' },
		46510 : { mtype:'cs', cost: 1241320, name:'Sensors', class:5, rating:'A', mass: 20.00, integ:106, pwrdraw:1.23, boottime:5, maxrng:8.00, scanangle:30.00, typemis:6960, fdid:128064242, fdname:'Int_Sensors_Size5_Class5' }, // verify price
		
		46650 : { mtype:'cs', cost:   88980, name:'Sensors', class:6, rating:'E', mass: 40.00, integ:102, pwrdraw:0.40, boottime:5, maxrng:8.00, scanangle:30.00, typemis:4800, fdid:128064243, fdname:'Int_Sensors_Size6_Class1' },
		46640 : { mtype:'cs', cost:  222440, name:'Sensors', class:6, rating:'D', mass: 16.00, integ: 90, pwrdraw:0.45, boottime:5, maxrng:8.00, scanangle:30.00, typemis:5400, fdid:128064244, fdname:'Int_Sensors_Size6_Class2' },
		46630 : { mtype:'cs', cost:  556110, name:'Sensors', class:6, rating:'C', mass: 40.00, integ:113, pwrdraw:0.50, boottime:5, maxrng:8.00, scanangle:30.00, typemis:6000, fdid:128064245, fdname:'Int_Sensors_Size6_Class3' }, // verify price
		46620 : { mtype:'cs', cost: 1390280, name:'Sensors', class:6, rating:'B', mass: 64.00, integ:136, pwrdraw:0.83, boottime:5, maxrng:8.00, scanangle:30.00, typemis:6600, fdid:128064246, fdname:'Int_Sensors_Size6_Class4' }, // verify price
		46610 : { mtype:'cs', cost: 3475690, name:'Sensors', class:6, rating:'A', mass: 40.00, integ:124, pwrdraw:1.50, boottime:5, maxrng:8.00, scanangle:30.00, typemis:7200, fdid:128064247, fdname:'Int_Sensors_Size6_Class5' },
		
		46750 : { mtype:'cs', cost:  249140, name:'Sensors', class:7, rating:'E', mass: 80.00, integ:118, pwrdraw:0.47, boottime:5, maxrng:8.00, scanangle:30.00, typemis:4960, fdid:128064248, fdname:'Int_Sensors_Size7_Class1' },
		46740 : { mtype:'cs', cost:  622840, name:'Sensors', class:7, rating:'D', mass: 32.00, integ:105, pwrdraw:0.53, boottime:5, maxrng:8.00, scanangle:30.00, typemis:5580, fdid:128064249, fdname:'Int_Sensors_Size7_Class2' },
		46730 : { mtype:'cs', cost: 1557110, name:'Sensors', class:7, rating:'C', mass: 80.00, integ:131, pwrdraw:0.59, boottime:5, maxrng:8.00, scanangle:30.00, typemis:6200, fdid:128064250, fdname:'Int_Sensors_Size7_Class3' },
		46720 : { mtype:'cs', cost: 3892770, name:'Sensors', class:7, rating:'B', mass:128.00, integ:157, pwrdraw:0.97, boottime:5, maxrng:8.00, scanangle:30.00, typemis:6820, fdid:128064251, fdname:'Int_Sensors_Size7_Class4' },
		46710 : { mtype:'cs', cost: 9731930, name:'Sensors', class:7, rating:'A', mass: 80.00, integ:144, pwrdraw:1.77, boottime:5, maxrng:8.00, scanangle:30.00, typemis:7440, fdid:128064252, fdname:'Int_Sensors_Size7_Class5' },
		
		46850 : { mtype:'cs', cost:  697580, name:'Sensors', class:8, rating:'E', mass:160.00, integ:135, pwrdraw:0.55, boottime:5, maxrng:8.00, scanangle:30.00, typemis:5120, fdid:128064253, fdname:'Int_Sensors_Size8_Class1' },
		46840 : { mtype:'cs', cost: 1743960, name:'Sensors', class:8, rating:'D', mass: 64.00, integ:120, pwrdraw:0.62, boottime:5, maxrng:8.00, scanangle:30.00, typemis:5760, fdid:128064254, fdname:'Int_Sensors_Size8_Class2' },
		46830 : { mtype:'cs', cost: 4359900, name:'Sensors', class:8, rating:'C', mass:160.00, integ:150, pwrdraw:0.69, boottime:5, maxrng:8.00, scanangle:30.00, typemis:6400, fdid:128064255, fdname:'Int_Sensors_Size8_Class3' },
		46820 : { mtype:'cs', cost:10899760, name:'Sensors', class:8, rating:'B', mass:256.00, integ:180, pwrdraw:1.14, boottime:5, maxrng:8.00, scanangle:30.00, typemis:7040, fdid:128064256, fdname:'Int_Sensors_Size8_Class4' },
		46810 : { mtype:'cs', cost:27249390, name:'Sensors', class:8, rating:'A', mass:160.00, integ:165, pwrdraw:2.07, boottime:5, maxrng:8.00, scanangle:30.00, typemis:7680, fdid:128064257, fdname:'Int_Sensors_Size8_Class5' },
	...
	//	 6651 : { mtype:'ipc', cost:    NaN, name:'Prisoner Cells',                 class:6, rating:'E', mass:40.00, cabincap:32, cabincls:'P', fdid:null,      fdname:'Int_PassengerCabin_Size6_Class0' },
		...
		24520 : { mtype:'iplc', cost: 388800, name:'Prospector Limpet Controller', class:5, rating:'B', mass: 32.00, integ:157, pwrdraw:0.72, boottime:4, maxlimpet: 4, lpactrng: 7800, limpettime:600, maxspd:200, minebonus:3.0, fdid:128671282, fdname:'Int_DroneControl_Prospector_Size5_Class4' },
		...
		27520 : { mtype:'irlc', cost: 388800, name:'Repair Limpet Controller', class:5, rating:'B', mass: 32.00, integ:157, pwrdraw:0.72, boottime:10, maxlimpet: 3, lpactrng:1560, limpettime:300, maxspd:200, lmprepcap:310, fdid:128777340, fdname:'Int_DroneControl_Repair_Size5_Class4' },
