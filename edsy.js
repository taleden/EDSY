	...
	*/
	...
	var readStoredModules = function() {
		...
		//	hashEncodeS(" 2B Enzyme, HC+Caustic (CG reward)")+"=FLIqG02G0050ypD4sPc8y00C_00Gu00", // CG reward // TODO: get sample to test import
			...
			hashEncodeS(" 1D/F Guardian Gauss, RF+HC")+"=GLXCG02G0092_156_00A_00Ew7sHD00L800P600T800YsPc", // Salvation tech broker (Bright Sentinel, Mbooni)
			hashEncodeS(" 2B/F Guardian Gauss, RF+HC")+"=GLYSG02G0092_156_00A_00Ew7sHD00L800P600T800YsPc", // Salvation tech broker (Bright Sentinel, Mbooni)
			hashEncodeS(" 1D/F Guardian Plasma, OC+Foc")+"=GLXFG02G0060vBo4zHx8y00Cw00H800KvLL", // Salvation tech broker (Bright Sentinel, Mbooni)
			hashEncodeS(" 2B/F Guardian Plasma, OC+Foc")+"=GLYVG02G0060vBo4zHx8y00Cw00H800KvLL", // Salvation tech broker (Bright Sentinel, Mbooni)
			hashEncodeS(" 1D/F Guardian Shard, LR+Foc, Pen")+"=GLXIG02G0090y0051Cp98HlDFm0H058K_7YP4J9V700YpXu", // Salvation tech broker (Bright Sentinel, Mbooni)
			hashEncodeS(" 2A/F Guardian Shard, LR+Foc, Pen")+"=GLYOG02G0090y0051Cp98HkDFm0H058K_7YP4JBV700YpXu", // Salvation tech broker (Bright Sentinel, Mbooni)
		//	hashEncodeS(" 2A/F Guardian Shard, LR5 (CG reward)")+"=GLYOG02G0080y0051Cp993DDFm0H058L800Op7uV700", // CG reward // TODO: get sample to test import
		...
		//	hashEncodeS(" 1D/F Mining Laser, LR, IR (CG reward)")+"=HJpqG03H0072y006y00AkPcEy00I_ezL800PBLL", // CG reward
			hashEncodeS(" 2B Seeker \"V1\", LW+HC, TC")+"=FK4lG03Q0072-Cp6ypDAsPcIwPcUoPcX000b000", // human tech broker
		//	hashEncodeS(" 2B Seeker, HC+RF, DM (CG reward)")+"", // TODO
		//	hashEncodeS(" 2E/F Multi-cannon, RF, PS (CG reward)")+"=GHewG0CS007Uy00Yuaab600f466n600soPcv400", // CG reward
		//	hashEncodeS(" 2B/F Rail, LR+HC, FC (CG reward)")+"=FKZyG03I0080-Cp8zCpT000Yyv4b000f000iu00r900", // TODO: CG reward? // TODO: get sample to test import
